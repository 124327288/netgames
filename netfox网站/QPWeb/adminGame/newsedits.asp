  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr bgcolor="#cfdded" class="txt"> 
            ...
            <td width="312" height="24"> <div align="center">文章标题</div></td>
            <td width="215" height="24"> <div align="center">文章出处</div></td>
            <td width="169" height="24"> <div align="center">发布时间</div></td>
            <td width="77" height="24"> <div align="center">管理评论</div></td>
...
if result_n<=0 then
	...
	rs.AbsolutePage=Page
          ...
          <tr bgcolor="#FFFFFF" class="txt"> 
            <td height="24" colspan="6"><div align="center">对不起,没有找到任何文章</div></td>
          </tr>
          <%
		response.end
		end if 
		...
		%>
          <tr bgcolor="#f0f5f9" class="txt"> 
            ...
            <td height="24"> <div align="center"><a href="newspl.asp?id=<%=rs("id")%>">管理评论</a></div></td>
            <%if newsclass<>"" then%>
            <%end if%>
