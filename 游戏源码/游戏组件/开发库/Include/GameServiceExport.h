...
public:
	...
	//查找用户
	virtual IServerUserItem * __cdecl SearchOnLineUserByGameID(DWORD dwGameID)=NULL;
	//查找用户
	virtual IServerUserItem * __cdecl SearchOffLineUserByGameID(DWORD dwGameID)=NULL;
...
////////////////////////////////////////////////////////////////////////////////
#ifdef _UNICODE
	#define VER_ITableUserActionEX INTERFACE_VERSION(1,1)
	static const GUID IID_ITableUserActionEX={0xcdff3c21,0x64fb,0x48ea,0x00ab,0x9c,0x8e,0x01,0xbd,0x61,0x00,0x51};
#else
	#define VER_ITableUserActionEX INTERFACE_VERSION(1,1)
	static const GUID IID_ITableUserActionEX={0x739f4fe8,0xc870,0x4d4e,0x0084,0xa9,0x57,0x3a,0xd5,0xc9,0x46,0x1b};
#endif

//动作事件
interface ITableUserActionEX : public IUnknownEx
{
	//银行操作
	virtual bool __cdecl OnActionUserBank(WORD wChairID, IServerUserItem * pIServerUserItem)=NULL;
	//操作判断
	virtual bool __cdecl IsAllowBankAction(WORD wChairID, IServerUserItem * pIServerUserItem)=NULL;
};
