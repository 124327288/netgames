...
#define GAME_NAME					TEXT("对调游戏")					//游戏名字
...
#define GS_UG_KOU					(GS_PLAYING+3)						//扣王状态
#define GS_UG_PLAY					(GS_PLAYING+4)						//游戏状态
#define GS_UG_WAIT					(GS_PLAYING+5)						//等待状态
...
#define SUB_S_KOU_WANG				104									//用户扣王
#define SUB_S_GAME_PLAY				105									//游戏开始
#define SUB_S_OUT_CARD				106									//用户出牌
#define SUB_S_THROW_RESULT			107									//甩牌结果
#define SUB_S_TURN_BALANCE			108									//一轮统计
#define SUB_S_GAME_END				109									//游戏结束
...
//用户扣王
struct CMD_C_KouWang
{
	BYTE							cbConcealCount;							//暗藏数目
	BYTE							cbConcealCard[8];						//暗藏扑克
	BYTE							cbUserCardCount;						//出牌数目
	BYTE							cbUserCardData[52];						//扑克列表
};
//////////////////////////////////////////////////////////////////////////
