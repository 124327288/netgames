...
Class GameObj
	...
	Public Sub CheckLogin()
		IF GetInfo(0,"form","login")="true" Then
			IF Not CodeIsTrue Then
				Response.Write "<script>err.innerHTML='<strong><font color=#000000>验证码错误!</font></strong>'</script>"
				Exit Sub
			End IF
			...
			IF Rs.Eof Then
				Response.Write "<script>err.innerHTML='<strong><font color=#000000>用户名或密码错误!</font></strong>'</script>"
				RsClose:DbClose
				Exit Sub
			Else
				Set md5= New MD5obj
				...
				Else
					Set Md5=Nothing
					IF Rs(4)=True Then
						Response.Write "<script>err.innerHTML='<strong><font color=#000000>此帐号已被管理员冻结!</font></strong>'</script>"
						RsClose:DbClose
						Exit Sub
					Else
						Session("UserID")=Rs(0)
	...
	Public Sub LoginInfo()
		...
		IF IsLogin Then
			...
			Response.Write("&nbsp;您好!<strong><font color=#ff0000>"& Session("UserName") &"</font></strong><br><br>&nbsp;您的ID号为:<font color=#ff0000><strong>"& Session("GameID") &"</strong></font>,<br>&nbsp;您是本站的"& Vip &"用户,您已成功登陆! <br><br>[<a href=""?exit=true"">退出登入</a>] [<a href=""UpdatePassWord.asp"">修改密码</a>]<br><br><br><br><br><br>")
			Response.Write "</td></tr>"
		Else
			Response.Write "<form name=""form1"" method=""post"" action="""">"
			Response.Write "<tr><td width=""40%"" align=""center""><strong>游戏账号</strong></td><td width=""60%""><input name=""UserName"" type=""text"" class=""user"" id=""UserName"" size=""10""></td>"
			Response.Write "</tr><tr><td align=""center""><strong>密　　码</strong></td>"
			Response.Write "<td><input name=""PassWord"" type=""password"" class=""user"" id=""PassWord"" size=""10""></td>"
			Response.Write "</tr><tr><td align=""center""><strong>附 加 码</strong></td>"
			...
			Response.Write "<tr><td><img src=""img/title_login_m2.gif"" width=""14"" height=""12""> <a href=""reg.asp"">注册帐号</a></td><td>"
			Response.Write "<img src=""img/title_login_m3.gif"" width=""14"" height=""12"" border=""0""> <a href=""Passwordprotection.Asp"">密码保护</a> </td></tr><tr><td>"
			Response.Write "<img src=""img/title_login_m1.gif"" width=""14"" height=""12""> <a href=""SSPassWord.asp"">密码申诉</a></td>"
	...
	Private Function IsWealthGame(UserID)
		...
		IF Not Rs.Eof Then
			BakErr "对不起,您目前正在银子类游戏房间(如梭哈,麻奖等)中!不能进行银行操作!","Bank.Asp"
		End IF
		RsClose:DbClose
	End Function
