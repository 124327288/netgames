...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("Land_RoguishOne.exe"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("Land_RoguishOneServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
