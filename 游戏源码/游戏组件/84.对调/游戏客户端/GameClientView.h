...
#define IDM_KOU						(WM_USER+104)						//扣王消息
#define IDM_GIVE_UP					(WM_USER+105)						//放弃消息
...
protected:
	...
	//扣牌变量
protected:
	BYTE							m_cbHandCardCount;					//手上选择张数
	BYTE							m_cbKouCardCount;					//底牌选择张数
...
public:
	...
	CCardControl					m_KouCardControl;					//扣王扑克
