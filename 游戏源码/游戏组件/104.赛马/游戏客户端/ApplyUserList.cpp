...
BOOL CApplyUser::OnInitDialog()
{
	...
	m_AppyUserList.InsertColumn(1,TEXT("游戏币"),LVCFMT_LEFT,120);
...
void CApplyUser::InserUser(tagApplyUser & ApplyUser)
{
	...
	//////////////////////////////////////////////////////////////////////////
	LONGLONG lNumber = ApplyUser.lUserScore;
	...
	/////////////////////////////////////////////////////////
	m_AppyUserList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,strNumber,0,0,0,0);
