...
protected:
	...
	WORD							m_wCurrentEnthronement;				//当前即位
	WORD							m_wCurrentHousecarl;					//当前侍卫
	BYTE							m_bGameEnd[GAME_PLAYER];
	bool							m_IsByOneself;						//皇帝明，暗保
	bool							m_IsKeep;							//侍卫明，暗保
	BYTE							m_EndOrder;
	BYTE							m_PassIndex;
	//运行信息
protected:
...
protected:
	...
	BYTE							m_bHandCardData[GAME_PLAYER][PLAYER_CARDS];				//手上扑克
