...
BEGIN_MESSAGE_MAP(CRichEditTrace, CRichEditCtrl)
	ON_WM_RBUTTONDOWN()
...
//////////////////////////////////////////////////////////////////////////
//接口查询
VOID * __cdecl CRichEditTrace::QueryInterface(const IID & Guid, DWORD dwQueryVer)
{
...
//////////////////////////////////////////////////////////////////////////
//追踪信息
bool __cdecl CRichEditTrace::TraceString(LPCTSTR pszString, enTraceLevel TraceLevel)
{
	//效验参数
	...
	CRichEditTrace *pRichEditTrace = static_cast<CRichEditTrace*>(pITraceService);
...
//////////////////////////////////////////////////////////////////////////
//绑定函数
VOID CRichEditTrace::PreSubclassWindow()
{
...
//////////////////////////////////////////////////////////////////////////
//加载消息
bool CRichEditTrace::LoadMessage(LPCTSTR pszFileName)
{
	if (static_cast<CRichEditTrace*>(g_pITraceService) == NULL) return false;
	return static_cast<CRichEditTrace*>(g_pITraceService)->LoadMessage(pszFileName);
}

//保存信息
bool CRichEditTrace::SaveMessage(LPCTSTR pszFileName)
{
	if (static_cast<CRichEditTrace*>(g_pITraceService) == NULL) return false;
	return static_cast<CRichEditTrace*>(g_pITraceService)->SaveMessage(pszFileName);
}

//设置参数
bool CRichEditTrace::SetParameter(LONG lMaxLineCount, LONG lReserveLineCount)
{
...
//////////////////////////////////////////////////////////////////////////
//配置服务
VOID CRichEditTrace::InitializeService()
{

}

//获取颜色
COLORREF CRichEditTrace::GetTraceColor(enTraceLevel TraceLevel)
{
	switch (TraceLevel)
	{
...
//插入字串
bool CRichEditTrace::InsertString(LPCTSTR pszString, CHARFORMAT2 & CharFormat)
{
...
//////////////////////////////////////////////////////////////////////////
//加载回调
DWORD CALLBACK CRichEditTrace::LoadCallBack(DWORD dwCookie, LPBYTE pbBuff, LONG cb, LONG * pcb)
{
	return 0;
}

//保存回调
DWORD CALLBACK CRichEditTrace::SaveCallBack(DWORD dwCookie, LPBYTE pbBuff, LONG cb, LONG * pcb)
{
	return 0;
}
...
//////////////////////////////////////////////////////////////////////////
//删除信息
VOID CRichEditTrace::OnClearAll()
{
	SetWindowText(NULL);
}

//全部选择
VOID CRichEditTrace::OnSelectAll()
{
	__super::SetSel(0, __super::GetTextLength());
}

//拷贝字符
VOID CRichEditTrace::OnCopyString()
{
	__super::Copy();
}

//保存信息
VOID CRichEditTrace::OnSaveString()
{
...
//删除字符
VOID CRichEditTrace::OnDeleteString()
{
...
//////////////////////////////////////////////////////////////////////////
//建立消息
INT CRichEditTrace::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
//追踪消息
LRESULT CRichEditTrace::OnTraceServiceMessage(WPARAM wParam, LPARAM lParam)
{
	return 0;
}
