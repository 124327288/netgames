...
CGameClientView::CGameClientView(void) : CGameFrameView(true,24)
{
    ...
    m_Image002.LoadImage(hInstance, TEXT( "IDR_PNG" ) );
...
int CGameClientView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_Image002.LoadImage(TEXT(""), WS_CHILD,CreateRect,this,IDRPNG);
	...
	m_Image002.LoadImage  (IDB_AUTOPLAY_ON,hInstance,false);
...
void CGameClientView::RectifyGameView(int nWidth, int nHeight)
{
	...
	CRect rcBtAutoPlay;
	m_Image002.DrawImage( rcBtAutoPlay );
	m_Image002 .DrawImage( nWidth - m_nXBorder - 5 - rcBtAutoPlay.Width() ,     nHeight-50, rcBtAutoPlay.Width(), rcBtAutoPlay.Height(), FALSE);
...
// 自动托管
void CGameClientView::IDRPNG()
{
    m_Image002.DrawImage(SW_HIDE);
