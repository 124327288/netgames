...
BYTE CGameLogic::GetCardType(const BYTE cbCardData[], BYTE cbCardCount)
{
	...
	if ((0+2)==(cbFistCardColor+cbSecondCardColor) && cbFirstCardValue==cbSecondCardValue && 6==cbFirstCardValue) return CT_SPECIAL_6;
	if ((0+2)==(cbFistCardColor+cbSecondCardColor) && cbFirstCardValue==cbSecondCardValue && 10==cbFirstCardValue) return CT_SPECIAL_6;
	if ((1+3)==(cbFistCardColor+cbSecondCardColor) && cbFirstCardValue==cbSecondCardValue && 4==cbFirstCardValue) return CT_SPECIAL_6; 

	if ((1+3)==(cbFistCardColor+cbSecondCardColor) && cbFirstCardValue==cbSecondCardValue && 10==cbFirstCardValue) return CT_SPECIAL_7; 
...
int CGameLogic::CompareCard(const BYTE cbFirstCardData[], BYTE cbFirstCardCount,const BYTE cbNextCardData[], BYTE cbNextCardCount)
{
	...
	{
		if (GetCardLogicValue(cbNextCardDataTmp[0]) > GetCardLogicValue(cbFirstCardDataTmp[0])) 
		{
			return 1;
		}else
		{
...
BYTE CGameLogic::GetCardLogicValue(BYTE cbCardData)
{
	...
	//红10=红6=黑4＞红7=红J=黑10=黑6 ＞  黑7 =黑8=红九=红五 
	...
	if((0==cbColor || 2==cbColor) &&7==cbValue) return 3;

	if ((1==cbColor || 3==cbColor) && (10==cbValue || 6==cbValue||11==cbValue )) return 3;
	...
	////红10=红6=黑4=黑10=黑6=红7=红J=黑8=黑7=红5=红九>大王==3


	//if ((1==cbColor || 3==cbColor) && (10==cbValue || 6==cbValue || 4==cbValue)) return 4;

	//if ((0==cbColor || 2==cbColor) && (10==cbValue || 6==cbValue || 7==cbValue)) return 4;

	//if ((1==cbColor || 3==cbColor) && 11==cbValue) return 4;

	//if ((1==cbColor || 3==cbColor) && (7==cbValue || 8==cbValue)) return 4;
	//if ((0==cbColor || 2==cbColor) && (5==cbValue || 9==cbValue)) return 4;
	...
	if (3==cbColor && (1==cbValue || 3==cbValue)) return 3;
