...
protected:
	...
	bool							m_bNotCall;							//是否没叫牌
	bool							m_bIsGanGuoBa;						//是否干锅巴
	bool							m_bIsRuanGanGuoBa;					//是否软干锅巴
	bool							m_bIsYingGanGuoBa;					//是否硬干锅巴
...
protected:
	...
	//扣王信息
protected:
	bool							m_bKouFlag[GAME_PLAYER];			    //扣王标志				
...
protected:
	...
	//用户扣王
	bool OnUserKouWang(WORD wChairID, BYTE cbConcealCard[], BYTE cbConcealCount,BYTE cbUserCard[], BYTE cbUserCardCount);
	//用户出牌
