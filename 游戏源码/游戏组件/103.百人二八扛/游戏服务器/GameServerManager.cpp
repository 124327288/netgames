...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription, TEXT("百人二八扛游戏服务组件"), CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szClientModuleName, TEXT("Baccarat28G.exe"), CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName, TEXT("Baccarat28GServer.DLL"), CountArray(m_GameServiceAttrib.szServerModuleName));
