...
bool __cdecl CGameServiceManager::RectifyServiceOption(tagGameServiceOption * m_pGameServiceOption)
{
	...
	if (m_pGameServiceOption->wServerType&GAME_GENRE_GOLD) m_pGameServiceOption->lLessScore=__max(m_pGameServiceOption->lCellScore*10L,m_pGameServiceOption->lLessScore);
