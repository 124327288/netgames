		...
		}else
		{
			   if(i<3)
			   {
				...
				if(4==i)
				{
					...
					m_ImageOpenCardHandle.AlphaDrawImage(pDC,OriginPoint.x-7,OriginPoint.y+nYDrawPos-8,m_ImageOpenCardHandle.GetWidth(),m_ImageOpenCardHandle.GetHeight(),0,0,RGB(255,0,255));
				}
				else
					m_ImageCard.AlphaDrawImage(pDC,OriginPoint.x+nXDrawPos+25,OriginPoint.y+nYDrawPos,m_CardSize.cx,m_CardSize.cy,nXImagePos,nYImagePos,RGB(255,0,255));
