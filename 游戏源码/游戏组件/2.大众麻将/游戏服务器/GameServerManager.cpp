...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("SparrowDZ.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("SparrowDZServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
