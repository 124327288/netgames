...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("A44游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("A44DVD.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("A44DVDServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
#else
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "QPTreasureDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("A44D.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("A44DServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
#endif
