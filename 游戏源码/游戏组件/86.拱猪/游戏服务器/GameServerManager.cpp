...
{	
	...
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("GameDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("拱猪游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("UncoverPigServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("UncoverPig.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
